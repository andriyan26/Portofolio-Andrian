    ...
    public function run(): void
    {
        ...
        $projects = [
            [
                ...
                'summary' => 'Website portofolio full-stack yang dibangun menggunakan framework Laravel 10 dengan arsitektur MVC bersih, estetika modern dark theme, formulir kontak terintegrasi, dan performa tinggi.',
                'description' => 'Aplikasi web portofolio personal yang dirancang khusus untuk memamerkan karya digital, perjalanan studi di Universitas Pamulang, pengalaman magang di Pusdiklat BPS, serta keterampilan full-stack programming. Dilengkapi dengan arsitektur Blade modular, sistem database dinamis MySQL, dan tata letak responsif untuk semua perangkat.',
